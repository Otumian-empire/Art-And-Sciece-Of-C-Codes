...
unsigned int randomNumber(unsigned int lower, unsigned int higher)
{
    ...
    ********************************************************************************
    ...
    unsigned int rand_val = (rand() % higher) + 1;
    // unsigned int rand_num = (rand_val < lower && ((higher - lower > lower - rand_val) || (higher - lower > lower - rand_val))) ? (((2 * lower) - higher) + 1) : rand_val;
    ...
    if (rand_val < lower)
    {
        ...
        if ((higher - rand_val) / 2 < lower)
        {
            average = higher - lower;
        }
        else if ((higher - rand_val) / 2 > lower)
        {
            average = (higher - rand_val) / 2;
        }
        // else
        // {
        //     average = lower - (higher - rand_val) / 2;
        // }
        ...
        else if ((higher - lower) < (lower - rand_val))
        {
            puts("Lower <");
            rand_num = ((2 * lower) - higher) + average;
        }
