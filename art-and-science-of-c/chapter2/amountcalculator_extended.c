...
an  account  balance,  an  annual interest  rate expressed  as  percentage and the time of investment.
...
int main() {
	float accountBalance, annualInterest, afterBalance, investmentTime;
